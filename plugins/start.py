...
async def cb_handler(client, query: CallbackQuery):
    ...
    if data == "start":
        await query.message.edit_text(
            text=f"""👋 𝐇𝐞𝐲 {query.from_user.mention} \n𝙸'𝚖 𝙰 𝚂𝚒𝚖𝚙𝚕𝚎 𝙵𝚒𝚕𝚎 𝚁𝚎𝚗𝚊𝚖𝚎+𝙵𝚒𝚕𝚎 𝚃𝚘 𝚅𝚒𝚍𝚎𝚘 𝙲𝚘𝚟𝚎𝚛𝚝𝚎𝚛 𝙱𝙾𝚃 𝚆𝚒𝚝𝚑 𝙿𝚎𝚛𝚖𝚊𝚗𝚎𝚗𝚝 𝚃𝚑𝚞𝚖𝚋𝚗𝚊𝚒𝚕 & 𝙲𝚞𝚜𝚝𝚘𝚖 𝙲𝚊𝚙𝚝𝚒𝚘𝚗 𝚂𝚞𝚙𝚙𝚘𝚛𝚝! """,
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup( [[
               ...
               InlineKeyboardButton("❣️ 𝚂𝙾𝚄𝚁𝙲𝙴", url="https://github.com/dor3Monbotz/crownRenameBot_V3")
               ],[
               InlineKeyboardButton("❤️‍🔥 𝙾𝚆𝙽𝙴𝚁  ❤️‍🔥", url='https://t.me/little_little_hackur')
               ],[
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup( [[
               ...
               InlineKeyboardButton("🖥️ 𝙾𝚆𝙽𝙴𝚁", url="https://t.me/little_little_hackur")
               ],[
               InlineKeyboardButton("🔒 𝙲𝙻𝙾𝚂𝙴", callback_data = "close"),
               InlineKeyboardButton("◀️ 𝙱𝙰𝙲𝙺", callback_data = "start")
               ]]
